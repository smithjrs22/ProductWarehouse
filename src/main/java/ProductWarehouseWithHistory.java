import java.text.MessageFormat; //message format helps with formatting
    ...
    public void printAnalysis() {
        System.out.println(
                MessageFormat.format("Product: {0}\nHistory: {1}\nLargest amount of product: {2}\nSmallest amount of product:{3}\nAverage: {4}",
                        super.getName(), changeHistory, changeHistory.maxValue(), changeHistory.minValue(), changeHistory.average()
                )
        );
    }
